...
export function CaptionDetail({
  ...
  return (
    <div className="w-80 border-l border-gray-800 flex flex-col overflow-hidden shrink-0">
      {/* Full-size image */}
      <div
        className="bg-gray-950 flex items-center justify-center shrink-0"
        ...
        <div className="pt-1 space-y-1">
          ...
          {isStreaming ? (
            ...
            <textarea
              ...
              rows={8}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-200 leading-relaxed focus:outline-none focus:border-violet-500 resize-y font-sans"
